...
**Handler naming:** Local handler functions must match the prop name they are passed to. Example: `onCreateButtonPress={onCreateButtonPress}`, not `onCreateButtonPress={openCreateModal}`.
